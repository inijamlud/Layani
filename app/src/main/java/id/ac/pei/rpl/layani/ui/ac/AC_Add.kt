...
class AC_Add : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.fragment_ac)
        declaration()
        myfunction()
    }
        ...
        btnSubmit.setOnClickListener {
            ...
            apiService.postOrder(array).enqueue(object : Callback<OrderService>{
                override fun onResponse(call: Call<OrderService>, response: Response<OrderService>) {
                    startActivity(Intent(this@AC_Add, MainActivity::class.java))
